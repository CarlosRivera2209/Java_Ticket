...
import Proyecto.CrearEventoAdmin;


public class EventosAdmin extends javax.swing.JFrame {

   ManejoUsuarios manejoUsuarios;
   EventManager eventManager;

    public EventosAdmin(ManejoUsuarios manejoUsuarios, EventManager eventManager) {
        initComponents();
    ...
    private void CrearEventActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CrearEventActionPerformed
        dispose();
        new CrearEventoAdmin( manejoUsuarios,  eventManager).setVisible(true);
    ...
    private void EliminEventActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminEventActionPerformed
        dispose();
        new BorrarEvento( manejoUsuarios,  eventManager).setVisible(true);
